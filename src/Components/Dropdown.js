  ...
  return (
    <Menu as="div" className="relative inline-block text-left w-full mt-5">
      <div>
        <Menu.Button
          id="dropdownHeader"
          className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-specBeige px-8 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
        >
          {menuBarText}
          <ChevronDownIcon
